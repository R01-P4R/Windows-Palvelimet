...
Koneen käynnistettyä loin Admin-käyttäjäprofiilin ja kirjauduin koneen työpöydälle käyttäenm luomiani tunnuksia ja Windowsin Server Manager-ohjelma avautui työpöydälle. Server Manageria käytään hallitsemaan Windows palvelinkoneen toimialuetta.

## Mallinnus: Windows-palvelinkoneen alustus

Tässä vaiheessa olisi tarkoitus mallintaa aikaisemmin luotua virtuaalikonetta käytettäväksi pohjana uusille virtuaalikoneille hyödyntäen sysrep-työkalua. Aloitin avaamalla luodun WindowsServer-virtuualikoneen CMD-ohjelman adminoikeuksilla ja syöttämällä komennon:
